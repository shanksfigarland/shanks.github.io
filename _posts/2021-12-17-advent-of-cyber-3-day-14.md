...
![Website]({{ site.baseurl }}/assets/img/aoc3day14/2.png "The Grinch")
...
```
Results:
![Gobuster]({{ site.baseurl }}/assets/img/aoc3day14/1.png "Gobuster")

As follows I checked both *admin* and *warez*.

admin            |  warez
:-------------------------:|:-------------------------:
![Admin]({{ site.baseurl }}/assets/img/aoc3day14/4.png "Admin") |  ![Warez]({{ site.baseurl }}/assets/img/aoc3day14/3.png "Warez")
...
![ls]({{ site.baseurl }}/assets/img/aoc3day14/5.png "ls")
...
![permissions]({{ site.baseurl }}/assets/img/aoc3day14/7.png "Permissions")
...
![File]({{ site.baseurl }}/assets/img/aoc3day14/6.png "File")

Checking the page............ and boom. It works. 

The code            |  Admin Page with the contents of /etc/shadow
:-------------------------:|:-------------------------:
![code]({{ site.baseurl }}/assets/img/aoc3day14/9.png "code") |  ![/etc/shadow]({{ site.baseurl }}/assets/img/aoc3day14/8.png "/etc/shadow")
...
![check.sh]({{ site.baseurl }}/assets/img/aoc3day14/9.png "check.sh")

We wait a few minutes and reload */admin* again to check its contents.

![check.sh]({{ site.baseurl }}/assets/img/aoc3day14/10.png "check.sh")
...
![remind]({{ site.baseurl }}/assets/img/aoc3day14/11.png "remindme")

Checking the html file we can confirm the password is *ELFSareFAST*.
Maybe we could use it for something?

![pass]({{ site.baseurl }}/assets/img/aoc3day14/12.png "pass")
...
![flag]({{ site.baseurl }}/assets/img/aoc3day14/13.png "flag")
